...
import local.matheus.bookstoreweb.model.dao.BookDAO;

/**
 *
 * @author devsys-b
 */
@WebServlet(name = "BookServlet", urlPatterns = {"/bstore"})
public class BookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(BookDAO.class.getName()).log(Level.INFO, "Path solicitado: {0}", action);
    ...
    private void updateBookAction(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(bookAtualizado.toString());
